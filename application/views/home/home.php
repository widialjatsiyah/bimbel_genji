...
<section id="home" class="p-0">
    <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <?php if (!empty($slides)): $first = true; foreach ($slides as $slide): ?>
...
<section id="features" style="background: #f8f9fa;">
    <div class="container">
        ...
        <div class="row g-4">
            <?php if (!empty($features)): $index = 0; foreach ($features as $feature): ?>
            ...
            <div class="col-md-4" data-aos="flip-left">
                <div class="card h-100 border-0 shadow-lg package-card">
                    <div class="card-body text-center p-5">
                        ...
                        <a href="#" class="btn btn-orange w-100">Pilih Paket</a>
                    </div>
                </div>
            </div>
            <?php endforeach; else: ?>
