				...
				<form id="form-tryout_session" autocomplete="off">
					...
					<div class="form-group">
						...
						<div class="form-group"> 	
							<div class="toggle-switch">
								<label>
									<input type="checkbox" name="enable_time_per_question" value="1" class="tryout_session-enable_time_per_question">
									<span class="toggle-slider"></span>
									<span class="toggle-label">Aktifkan batas waktu per soal</span>
								</label>
							</div>
						</div>
						<div class="form-group" id="time_per_question_container" style="display:none;">
							<label required>Waktu Per Soal (detik)</label>
							<input type="number" name="time_per_question" class="form-control tryout_session-time_per_question" min="1" value="60" placeholder="Jumlah detik per soal" />
							<i class="form-group__bar"></i>
						</div>
					</div>
