                        ...
                        <div class="card-body">
                            ...
                            <form id="form-add-material">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="material_id" id="material-select" class="form-control select2" style="width: 100%;"></select>
                                </div>
                                <div class="form-group">
                                    <label>Urutan (opsional)</label>
                                    <input type="number" name="order_num" class="form-control" min="0" value="0">
                                </div>
                                <button type="button" class="btn btn-primary" id="btn-add-material">Tambah</button>
                            </form>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="table-materials">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Judul</th>
