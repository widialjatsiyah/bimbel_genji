		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="form-question-import" autocomplete="off" enctype="multipart/form-data">
					...
					<div class="row alert alert-info" style="font-size: 10px;">
						<div class="col-md-8" >
							...
							<ol class="mb-0">
								...
								<li>Upload file Excel yang telah diisi <b>sesuai mata pelajaran</b></li>
							</ol>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<button type="button" class="btn btn-sm btn-outline-primary question-import-download-template">
