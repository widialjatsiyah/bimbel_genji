<section id="question-form">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title"><?php echo (isset($card_title)) ? $card_title : 'Form Soal' ?></h4>
            ...
            <form id="form-question" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <textarea name="explanation" class="form-control question-explanation tinymce-init" rows="3" placeholder="Penjelasan jawaban (opsional)"></textarea>
                    <i class="form-group__bar"></i>
                </div>
