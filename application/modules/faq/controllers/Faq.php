...
class Faq extends AppBackend
{
    public function __construct()
    {
        parent::__construct();
       
        $this->load->model(['AppModel', 'FaqModel']);
    }
    ...
    public function index()
    {
        $data = [
            'app' => $this->app(),
            'main_js' => $this->load_main_js('faq'),
            'card_title' => 'Kelola FAQ'
        ];
    ...
    public function ajax_save($id = null)
    {
        ...
        if ($this->form_validation->run() == true) {
            if (is_null($id)) {
                $res = $this->FaqModel->insert();
            } else {
                $res = $this->FaqModel->update($id);
            }
