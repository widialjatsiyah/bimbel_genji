...
(function (d) {
      ...
      var c = function (e) {
        for (var g = 0, h = e.length; g < h; g++) {
          ...
          if (f.key)
            ...
            else if (d.isPlainObject(f.key) && f.key.key === a && (!f.key.shiftKey || b.shiftKey)) if (!f.key.altKey || b.altKey) if (!f.key.ctrlKey || b.ctrlKey) (!f.key.metaKey || b.metaKey) && d(r).click();
        ...
        h && "absolute" === f
          ...
          : "absolute" === f
            ? (e._collection.css({ top: a.top + c.outerHeight(), left: a.left }),
              (h = g.offset().top + g.height()),
              (c = a.top + c.outerHeight() + e._collection.outerHeight() - h),
              (h = a.top - e._collection.outerHeight()),
              (h = g.offset().top - h),
              c > h && e._collection.css("top", a.top - e._collection.outerHeight() - 5),
              (c = a.left + e._collection.outerWidth()),
              (g = g.offset().left + g.width()),
              c > g && e._collection.css("left", a.left - (c - g)))
            : ((a = e._collection.height() / 2), a > d(n).height() / 2 && (a = d(n).height() / 2), e._collection.css("marginTop", -1 * a));
  ...
  i.Api.registerPlural("buttons().containers()", "buttons().container()", function () {
    ...
    this.iterator(!0, "table", function (c) {
      if (c._buttons) for (var c = m.instanceSelector(b, c._buttons), d = 0, g = c.length; d < g; d++) a = a.add(c[d].container());
    });
    return a;
  });
